...
public class ChoosyGirl extends Girl {
   ...
   * @param attractiveness This is the fourth parameter to ChoosyGirl Constructor.
   * @param MBudget This is the fifth parameter to ChoosyGirl Constructor.
   * 
   */ 
      
    ChoosyGirl(String name,String pairedto,String intelligence,String attractiveness,String MBudget) {
